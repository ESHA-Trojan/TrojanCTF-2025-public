...
func main() {
	sdk.Run(func(req *sdk.Request, resp *sdk.Response, opts ...pulumi.ResourceOption) error {
		cm, err := k8s.NewExposedMonopod(req.Ctx, "chal2-whitehats", &k8s.ExposedMonopodArgs{
			Identity: pulumi.String(req.Config.Identity),
			Hostname: pulumi.String("isolated.trojanc.tf"),
			Container: k8s.ContainerArgs{
				Image: pulumi.String("isolatedchallengesv4registry.azurecr.io/web/chal2-whitehats:latest"),
		...
		resp.ConnectionInfo = pulumi.Sprintf("https://%s", cm.URLs.MapIndex(pulumi.String("8000/TCP")))
		return nil
	})
}
